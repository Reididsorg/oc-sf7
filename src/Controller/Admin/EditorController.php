...
class EditorController extends AbstractController
{
    ...
    public function new(?Editor $editor, Request $request, EntityManagerInterface $manager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $manager->flush();
            // les données de $editor sont maintenant dans la base de données
            // ici, $editor->getId() vous renvoie l'id de la ligne qui vient d'être ajoutée en base de données
